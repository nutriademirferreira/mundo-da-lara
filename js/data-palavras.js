...
var Palavras = (function () {
  ...
  var FASES = [
    { palavra:'BOLA',   falta:0, erradas:['M','S'], desenho:desenhoBola, cena:'quarto' },
    { palavra:'GATO',   falta:0, erradas:['T','F'], desenho:desenhoGato, cena:'fazenda' },
    { palavra:'SOL',    falta:1, erradas:['A','E'], desenho:desenhoSol, cena:'ceu' },
    { palavra:'LUA',    falta:1, erradas:['I','O'], desenho:desenhoLua, cena:'ceu' },
    { palavra:'PATO',   falta:0, erradas:['L','N'], desenho:desenhoPato, cena:'fazenda' },
    { palavra:'CASA',   falta:2, erradas:['Z','R'], desenho:desenhoCasa, cena:'quarto' },
    { palavra:'BOLO',   falta:2, erradas:['R','V'], desenho:desenhoBolo, cena:'cozinha' },
    { palavra:'SAPO',   falta:1, erradas:['E','O'], desenho:desenhoSapo, cena:'fazenda' },
    { palavra:'FLOR',   falta:0, erradas:['V','T'], desenho:desenhoFlor, cena:'fazenda' },
    { palavra:'PEIXE',  falta:3, erradas:['S','C'], desenho:desenhoPeixe, cena:'agua' },
    { palavra:'OVO',    falta:1, erradas:['L','F'], desenho:desenhoOvo, cena:'cozinha' },
    { palavra:'UVA',    falta:0, erradas:['A','O'], desenho:desenhoUva, cena:'cozinha' },
    { palavra:'PERA',   falta:0, erradas:['T','M'], desenho:desenhoPera, cena:'cozinha' },
    { palavra:'BANANA', falta:2, erradas:['M','L'], desenho:desenhoBanana, cena:'cozinha' },
    { palavra:'SUCO',   falta:0, erradas:['F','R'], desenho:desenhoSuco, cena:'cozinha' },
    { palavra:'PIZZA',  falta:0, erradas:['T','L'], desenho:desenhoPizza, cena:'cozinha' },
    { palavra:'PIPOCA', falta:4, erradas:['G','S'], desenho:desenhoPipoca, cena:'cozinha' },
    { palavra:'VACA',   falta:0, erradas:['F','N'], desenho:desenhoVaca, cena:'fazenda' },
    { palavra:'PORCO',  falta:2, erradas:['L','N'], desenho:desenhoPorco, cena:'fazenda' },
    { palavra:'RATO',   falta:0, erradas:['M','N'], desenho:desenhoRato, cena:'fazenda' },
    { palavra:'URSO',   falta:0, erradas:['O','A'], desenho:desenhoUrso, cena:'fazenda' },
    { palavra:'GALO',   falta:0, erradas:['T','F'], desenho:desenhoGalo, cena:'fazenda' },
    { palavra:'ABELHA', falta:1, erradas:['L','M'], desenho:desenhoAbelha, cena:'fazenda' },
    { palavra:'CARRO',  falta:0, erradas:['G','S'], desenho:desenhoCarro, cena:'quarto' },
    { palavra:'BARCO',  falta:0, erradas:['M','S'], desenho:desenhoBarco, cena:'agua' },
    { palavra:'TREM',   falta:0, erradas:['F','L'], desenho:desenhoTrem, cena:'quarto' },
    { palavra:'CAMA',   falta:2, erradas:['N','V'], desenho:desenhoCama, cena:'quarto' },
    { palavra:'LIVRO',  falta:0, erradas:['N','T'], desenho:desenhoLivro, cena:'quarto' },
    { palavra:'COPO',   falta:0, erradas:['T','S'], desenho:desenhoCopo, cena:'cozinha' },
    { palavra:'NUVEM',  falta:0, erradas:['M','R'], desenho:desenhoNuvem, cena:'ceu' }
  ];
